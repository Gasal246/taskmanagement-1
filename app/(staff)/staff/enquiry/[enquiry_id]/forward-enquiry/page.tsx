...
export default function EscalatePage() {
  ...
  const handleSubmit = async () => {
    ...
    if (res?.status == 201) {
      ...
      return router.replace(`/staff/enquiry/${enquiry_id}/history`);
    }
  ...
  const handleCloseEnquiry = async () => {
    ...
    if (res?.status == 200) {
      ...
      return router.replace(`/staff/enquiry/${enquiry_id}`)
    } else {
    ...
    <div className="p-5 pb-10">
      ...
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink onClick={() => router.replace(`/staff/enquiry/${enquiry_id}`)}>Enquiry Details</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
