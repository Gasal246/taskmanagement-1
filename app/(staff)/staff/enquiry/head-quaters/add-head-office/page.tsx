...
import { useAddNewStaffEqHeadOffice, useGetStaffEqCampsFiltered } from "@/query/enquirymanager/queries";
import {
    Pagination,
    PaginationContent,
    PaginationEllipsis,
...
export default function AddHeadOfficePage() {
    ...
    const { mutateAsync: AddHeadOffice, isPending: isAdding } = useAddNewStaffEqHeadOffice();
