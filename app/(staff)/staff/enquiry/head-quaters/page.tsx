...
import { useGetStaffEqHeadOfficesFiltered } from "@/query/enquirymanager/queries";
import {
    Pagination,
    PaginationContent,
    PaginationEllipsis,
...
export default function HeadOfficesListPage() {
    ...
    const { data: headOffices, isLoading } = useGetStaffEqHeadOfficesFiltered({ search, page, limit });
        ...
        <div className="p-5 pb-10">
            ...
            <div className="p-6 max-w-5xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/staff/enquiry/head-quaters/add-head-office">
                    ...
                    <table className="w-full text-sm text-slate-300">
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <tr><td colSpan={3} className="p-4 text-center text-slate-400">No head offices found for your account.</td></tr>
                            ) : (
                                headOffices?.head_offices?.map((office: any) => (
                                    <tr
                                        key={office._id}
                                        onClick={() => router.push(`/staff/enquiry/head-quaters/${office._id}`)}
