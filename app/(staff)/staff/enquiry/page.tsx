...
export default function EnquiriesPage() {
  ...
  // Queries
  const { data: enquiries, isLoading } = useGetAccessEnquiriesForStaffs(filters);
      ...
      {/* HEADER */}
            <div className="bg-gradient-to-tr from-slate-950/50 to-slate-900/50 p-3 rounded-lg mb-4 flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghost" className="text-xs" onClick={() => router.push("/staff/enquiry/assigns")}>
                  Assigned to you
                </Button>
                </div>
                </div>
        ...
        <div className="space-y-2">
          {enquiries?.enquiries?.map((e:any) => (
            <div
              ...
              onClick={()=> router.replace(`/staff/enquiry/${e._id}?from=accessible`)}
            >
