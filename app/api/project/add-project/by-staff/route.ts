        ...
        if(userRole?.role_name == "BUSINESS_ADMIN"){
            ...
            switch(userRole?.role_name){
                case 'REGION_DEP_HEAD':
                    ...
                    const projectDept = new Project_Departments({
                        project_id: savedProject._id,
                        department_id: body.dept_id,
                        department_name: isSales?.reg_dep_id?.dep_name,
                        is_active: false
                    });
                ...
                case 'AREA_DEP_HEAD':
                    ...
                    const project_dept = new Project_Departments({
                        project_id: savedProjectByStaff._id,
                        department_id: body.dept_id,
                        department_name: isSalesArea?.area_dep_id?.dep_name,
                        is_active: false
                    });

                    await project_dept.save();
                ...
                case 'LOCATION_DEP_HEAD':
                    ...
                    const proj_dept = new Project_Departments({
                        project_id: savedProjectByLocation._id,
                        department_id: body.dept_id,
                        department_name: isSalesLocation?.location_dep_id?.dep_name,
                        is_active: false
                    });

                    await proj_dept.save();
                ...
                case "REGION_DEP_STAFF": 
                    ...
                    const proj_dep = new Project_Departments({
                        project_id: savedByRegionStaff._id,
                        department_id: body?.dept_id,
                        department_name: isRegionSales?.region_dep_id?.dep_name,
                        is_active: false
                    });
                ...
                case "AREA_DEP_STAFF":
                    ...
                    const proj_department = new Project_Departments({
                        project_id: savedAreaStaffProject._id,
                        department_id: body?.dept_id,
                        department_name: isAreaSalesStaff?.area_dep_id?.dep_name,
                        is_active: false
                    });

                    await proj_department.save();
                ...
                case "LOCATION_DEP_STAFF":
                    ...
                    const project_department = new Project_Departments({
                        project_id: savedLocationStaffProject._id,
                        department_id: body?.dept_id,
                        department_name: isLocSalesStaff?.location_dep_id?.dep_name,
                        is_active: false
                    });

                    await project_department.save();
