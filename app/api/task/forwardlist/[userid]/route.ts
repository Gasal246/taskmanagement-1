    ...
    try {
        ...
        switch(userData?.Role) {
            ...
            case 'dep-head': {
                ...
                yourStaffs = await Users.find({ Department: department?._id, Role: 'dep-staff' }, { Name: 1, Email: 1, AvatarUrl: 1, Skills: 1, Role: 1 });
            } break;
            case 'region-head': {
                ...
                yourStaffs = await Users.find({ Region: region?._id, Role: 'reg-staff' }, { Name: 1, Email: 1, AvatarUrl: 1, Skills: 1, Role: 1 });
            } break;
            case 'area-head': {
                ...
                yourStaffs = await Users.find({ Area: area?._id, Role: 'staff' }, { Name: 1, Email: 1, AvatarUrl: 1, Skills: 1, Role: 1 });
            } break;
            default: {
