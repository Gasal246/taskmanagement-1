        ...
        <div className="p-5 pb-10">
            ...
            <div className="p-6 max-w-5xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-lg font-semibold text-slate-200">Provinces</h1>
                    <Link href="/admin/enquiries/provinces/add-province">
                        <Button className="bg-cyan-700 hover:bg-cyan-600">Add New Province</Button>
                    </Link>
                </div>
                    ...
                    <table className="w-full text-sm text-slate-300">
                        <thead className="bg-slate-800/50 text-slate-200">
                            <tr>
                                ...
                                <th className="p-3 text-left">Province Name</th>
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                <tr><td colSpan={4} className="p-4 text-center text-slate-400">No provinces found.</td></tr>
                            ) : (
                                provinces?.provinces?.map((province: any) => (
                                    ...
                                    >
                                        <td className="p-3">{province.country_id?.country_name}</td>
                                        <td className="p-3">{province.region_id?.region_name}</td>
                                        <td className="p-3">{province.province_name}</td>
                                        <td className="p-3">{province.updatedAt ? new Date(province.updatedAt).toLocaleDateString() : "-"}</td>
                                    </tr>
                                ))
                            )}
                        </tbody>
