...
import { useAddNewEqHeadOffice, useGetEqCampsFiltered } from "@/query/enquirymanager/queries";
import {
    Pagination,
    PaginationContent,
    PaginationEllipsis,
...
export default function AddHeadOfficePage() {
    ...
    const { mutateAsync: AddHeadOffice, isPending: isAdding } = useAddNewEqHeadOffice();
    ...
    const onSubmit = async (values: any) => {
        ...
        toast.error(res?.message || "Failed to add head office");
    };
        ...
        <div className="p-5 pb-10">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage>Add Head Office</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
