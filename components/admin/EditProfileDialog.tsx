...
const EditProfileDialog = ({ trigger, userData }: { trigger: React.ReactNode, userData: any }) => {
        ...
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>be careful on your updations</DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="enter you new name" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        />
                        <Button type="submit">{editting ? 'Editting..' : 'Change'}</Button>
                    </form>
                </Form>
            </DialogContent>
        </Dialog>
